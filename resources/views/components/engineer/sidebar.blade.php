...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li>
                <a href="{{ route('serviceEngineer.dashboard') }}">
                    <i class="fa-solid fa-gauge-high"></i>
                    <span class="link_name">Dashboard</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="{{ route('serviceEngineer.dashboard') }}">Dashboard</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="{{ route('serviceEngineer.addNewCase') }}">Add Cases</a></li>
            ...
            <li>
                <div class="iocn-link">
                    <a href="#">
                        ...
                        <span class="link_name">Administration Management</span>
                    </a>
                    <i class='bx bxs-chevron-down arrow'></i>
                </div>
                <ul class="sub-menu">
