...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li>
                <a href="{{ route('systemAdmin.dashboard') }}">
                    <i class="fa-solid fa-gauge-high"></i>
                    <span class="link_name">Dashboard</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="{{ route('systemAdmin.dashboard') }}">Dashboard</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="{{ route('systemAdmin.addNewCase') }}">Add Cases</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="#">View C.S.</a></li>
                    <li><a href="#">Create C.S.</a></li>
                    <li><a href="#">Update C.S.</a></li>
                    <li><a href="#">Delete C.S.</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a href="{{ route('systemAdmin.userManagement') }}">User Management</a></li>
                    <li><a href="{{ route('systemAdmin.roleManagement') }}">Role Management</a></li>
                </ul>
            </li>
