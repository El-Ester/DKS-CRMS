        ...
        <tbody>
            @foreach($jobs as $job)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('hrd.manage_hiring.view', $job->id) }}" class="btn btn-primary">View Job</a>
                        ...
                        <a href="{{ route('hrd.manage_hiring.candidates', $job->id) }}" class="btn btn-secondary">Manage Candidates</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
