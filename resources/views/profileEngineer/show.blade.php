        ...
        <div class="container mt-4">
            ...
            <div class="card p-4 shadow-sm">
                ...
                <div class="mt-3 d-flex gap-2">
                    <a href="{{ route('serviceEngineer.dashboard') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
                    <a href="{{ route('profileEngineer.edit') }}" class="btn btn-primary">Update Password</a>
                </div>
            </div>
        </div>
    </section>
