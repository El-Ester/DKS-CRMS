...
return [
    ...
    */
    ...
    'options' => [
        'enable_remote' => true,  // Allow fetching external images, CSS, etc.
        'enable_php' => false, // Keep disabled for security
        'enable_javascript' => true, // If your PDFs require JS
        'default_paper_size' => 'a4', // Set default paper size
        'dpi' => 96, // Adjust DPI if needed
        'font_dir' => storage_path('fonts'),
        'font_cache' => storage_path('fonts'),
        'temp_dir' => storage_path('temp'), // Ensure writable temp directory
        'chroot' => realpath(base_path()), // Set the root directory for security
    ],
